...
OBJECT_V3 = [
    ...
    ("maleta preta com um brilho dourado dentro", "Pulp Fiction", 1994),
    ("tapete voador azul", "Aladdin", 1992),
    ("carro Aston Martin prata com banco ejetável", "007 contra Goldfinger", 1964),
    ("um sabre de luz herdado do pai", "Guerra nas Estrelas", 1977),
    ("par de sapatos vermelhos que levam pra casa", "O Mágico de Oz", 1939),
    ("bola de vôlei com um rosto de sangue chamada Wilson", "Náufrago", 2000),
    ("carro Ferrari vermelho conversível roubado num dia de folga", "Curtindo a Vida Adoidado", 1986),
    ("guarda-roupa que dá num bosque de neve", "As Crônicas de Nárnia", 2005),
    ("navio pirata chamado Pérola Negra", "Piratas do Caribe", 2003),
    ("um chicote e um chapéu de couro procurando a arca", "Os Caçadores da Arca Perdida", 1981),
    ("carro amarelo que vira robô", "Transformers", 2007),
    ("um escudo redondo com uma estrela no meio", "Capitão América: O Primeiro Vingador", 2011),
    ("uma luva dourada com seis pedras", "Vingadores: Guerra Infinita", 2018),
    ("um Ford Gran Torino verde na garagem de um veterano rabugento", "Gran Torino", 2008),
    ("prancha voadora rosa sem rodas", "De Volta para o Futuro Parte II", 1989),
    ("um Ford Anglia azul que voa", "Harry Potter e a Câmara Secreta", 2002),
    ("ônibus que explode se andar devagar", "Velocidade Máxima", 1994),
    ("um walkman e uma fita cassete da mãe", "Guardiões da Galáxia", 2014),
    ("uma moto que solta rastro de luz numa grade digital", "Tron: O Legado", 2010),
    ("um cubo azul brilhante cheio de energia", "Os Vingadores", 2012),
    ("máquina do tempo feita de banheira de hidromassagem", "A Ressaca do Tempo", 2010),
    ("um coelho de terno olhando o relógio com pressa", "Alice no País das Maravilhas", 1951),
    ("um violino vermelho que passa de dono em dono por séculos", "O Violino Vermelho", 1998),
    ("um cortador de grama guiado por um trator num filme baseado em fatos reais", "Uma História Simples", 1999),
    ("bolsa de couro com um gremlin dentro", "Gremlins", 1984),
    ("um par de óculos escuros que mostra a verdade do mundo", "Eles Vivem", 1988),
    ("uma pipa vermelha e dois meninos no Afeganistão", "O Caçador de Pipas", 2007),
]
